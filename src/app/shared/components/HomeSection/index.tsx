    ...
    <ContentContainer className="home" type="primary">
      ...
      <StyledMainContainer>
        <div className="content-wrapper">
          ...
          <p>
            Este evento, previsto para ocorrer anualmente, é uma celebração do conhecimento e da inovação, criado por e para os alunos dos Cursos Técnico em Informática Integrado ao Ensino Médio e Análise e Desenvolvimento de Sistemas, bem como sociedade araguainense em geral.
          </p>
